...
Drop the whitebox-client `voip` tracker into your site and tag any phone number you want trackable:
...
```js
import { createWhitebox } from 'whitebox-client'
