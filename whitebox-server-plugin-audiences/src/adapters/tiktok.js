// TikTok adapter — Mode A: fire an Events API custom event; build a Custom
// Audience from that activity in TikTok Ads Manager. See docs/networks/tiktok.md.
    ...
    async sendEvent(canonical, ids) {
      ...
      const body = {
        ...
        data: [{
          ...
          user,
          ...(canonical.value != null ? { properties: { value: canonical.value } } : {}),
        }],
      }
