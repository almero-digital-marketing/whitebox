# whitebox-client-plugin-shortener

The landing-page half of a personalized short link. When a visitor arrives via a
[shortener](../whitebox-server-plugin-shortener) link, the server's redirect left
...
import shortener from 'whitebox-client-plugin-shortener'
